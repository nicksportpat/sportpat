...
namespace Sportpat\HomeBanner\Block;

use Magento\Framework\Model\AbstractModel;
use Sportpat\HomeBanner\Model\Uploader;
use Sportpat\HomeBanner\Helper\Image as ImageHelper;
use Sportpat\HomeBanner\Helper\ImageFactory as HelperFactory;
...
class ImageBuilder
{
    ...
    public function create()
    {
        ...
        $template = $helper->getFrame()
            ? 'Sportpat_HomeBanner::image.phtml'
            : 'Sportpat_HomeBanner::image_with_borders.phtml';
