...
namespace Sportpat\HomeBanner\Helper;
...
use Sportpat\HomeBanner\Model\ImageFactory;
...
class Image extends AbstractHelper
{
     ...
     * Current model
     *
     * @var \Sportpat\HomeBanner\Model\Image
     */
    protected $model;
    /**
     * @var Uploader
     ...
     * image factory
     *
     * @var \Sportpat\HomeBanner\Model\ImageFactory
     */
     ...
     *
     * @see \Sportpat\HomeBanner\Model\Image
     * @param int $width
     * @param int $height
     * @return $this
     */
     ...
     *
     * @see \Sportpat\HomeBanner\Model\Image\Image
     ...
     *
     * @return \Sportpat\HomeBanner\Model\Image
     */
    ...
    public function getFrame()
    {
        ...
        if (empty($frame)) {
            $frame = $this->getConfigView()->getVarValue('Sportpat_HomeBanner', 'image_white_borders');
        }
        return $frame;
    }
