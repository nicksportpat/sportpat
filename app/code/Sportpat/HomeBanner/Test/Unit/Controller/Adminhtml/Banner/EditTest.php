...
use Sportpat\HomeBanner\Controller\Adminhtml\Banner\Edit;
use Magento\Framework\View\Page\Config;

class EditTest extends TestCase
{
    /**
     * @covers \Sportpat\HomeBanner\Controller\Adminhtml\Banner\Edit::execute()
     */
    public function testExecute()
    {
        ...
        $controller = new Edit($context, $bannerRepository, $registry);
