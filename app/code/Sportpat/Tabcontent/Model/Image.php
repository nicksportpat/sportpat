    ...
    public function getUrl()
    {
        if ($this->newFile === true) {
            $url = $this->assetRepo->getUrl(
                "Sportpat_Tabcontent::images/" . $this->entityCode . "/placeholder/{$this->getDestinationSubdir()}.png"
            );
        } else {
            $url = $this->storeManager->getStore()->getBaseUrl(UrlInterface::URL_TYPE_MEDIA) . $this->newFile;
        }
        return $url;
    }
