...
namespace Sportpat\Tabcontent\Helper;
...
use Sportpat\Tabcontent\Model\ImageFactory;
...
class Image extends AbstractHelper
{
     ...
     * Current model
     *
     * @var \Sportpat\Tabcontent\Model\Image
     */
    protected $model;
    /**
     * @var Uploader
     ...
     * image factory
     *
     * @var \Sportpat\Tabcontent\Model\ImageFactory
     */
     ...
     *
     * @see \Sportpat\Tabcontent\Model\Image
     * @param int $width
     * @param int $height
     * @return $this
     */
     ...
     *
     * @see \Sportpat\Tabcontent\Model\Image\Image
     ...
     *
     * @return \Sportpat\Tabcontent\Model\Image
     */
    ...
    public function getFrame()
    {
        ...
        if (empty($frame)) {
            $frame = $this->getConfigView()->getVarValue('Sportpat_Tabcontent', 'image_white_borders');
        }
        return $frame;
    }
